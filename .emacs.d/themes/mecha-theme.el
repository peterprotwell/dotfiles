...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(elixir-atom-face ((,class (:foreground ,builtin))))
   ...
   `(isearch ((,class (:bold t :foreground ,grey11 :background ,type))))
   ...
   `(lazy-highlight ((,class (:foreground ,grey9 :background ,builtin))))
   ...
   `(term-color-green ((,class (:foreground ,type :background ,grey9))))
   ...
   `(helm-separator ((,class (:foreground ,type :background ,grey11))))
   `(helm-time-zone-current ((,class (:foreground ,builtin :background ,grey11))))
   `(helm-time-zone-home ((,class (:foreground ,type :background ,grey11))))
   `(helm-buffer-not-saved ((,class (:foreground ,type :background ,grey11))))
   `(helm-buffer-process ((,class (:foreground ,builtin :background ,grey11))))
   `(helm-buffer-saved-out ((,class (:foreground ,grey1 :background ,grey11))))
   `(helm-buffer-size ((,class (:foreground ,grey1 :background ,grey11))))
   `(helm-ff-directory ((,class (:foreground ,func :background ,grey11 :weight bold))))
   ...
   `(helm-grep-running ((,class (:foreground ,func :background ,grey11))))
   `(helm-moccur-buffer ((,class (:foreground ,func :background ,grey11))))
   ...
   `(company-preview-search ((,class (:foreground ,type :background ,grey11))))
   ...
   `(wg-mode-line-face ((,class (:foreground ,builtin))))
   `(wg-divider-face ((,class (:foreground ,builtin))))
   `(ahs-plugin-defalt-face ((,class (:background ,broown))))
