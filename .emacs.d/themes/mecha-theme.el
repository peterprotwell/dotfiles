...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-builtin-face ((,class (:foreground ,oranj1))))
   ...
   `(font-lock-function-name-face ((,class (:foreground ,oranj2 :bold t))))
   `(font-lock-keyword-face ((,class (:bold ,class :foreground ,grey4))))
   `(font-lock-string-face ((,class (:foreground ,oranj4))))
   `(enh-ruby-string-delimiter-face ((,class (:foreground ,oranj4))))
   `(enh-ruby-op-face ((,class (:foreground ,grey7))))
   `(elixir-operator-face ((,class (:foreground ,grey7))))
   `(elixir-atom-face ((,class (:foreground ,oranj1))))
   `(font-lock-type-face ((,class (:foreground ,oranj3 ))))
   `(font-lock-variable-name-face ((,class (:foreground ,var))))
   `(font-lock-warning-face ((,class (:foreground ,warning :background ,grey10))))
   `(region ((,class (:background ,grey1 :foreground ,grey11))))
   ...
   `(isearch ((,class (:bold t :foreground ,grey11 :background ,oranj3))))
   ...
   `(mode-line-buffer-id ((,class (:bold t :foreground ,oranj2 :background nil))))
   ...
   `(org-link ((,class (:underline t :foreground ,oranj3 ))))
   `(org-special-keyword ((,class (:foreground ,oranj2))))
   ...
   `(org-scheduled ((,class (:foreground ,oranj3))))
   `(org-scheduled-today ((,class (:foreground ,oranj2 :weight bold :height 1.2))))
   `(org-ellipsis ((,class (:foreground ,oranj1))))
   `(org-verbatim ((,class (:foreground ,grey5))))
   `(org-document-info-keyword ((,class (:foreground ,oranj2))))
   `(font-latex-bold-face ((,class (:foreground ,oranj3))))
   `(font-latex-italic-face ((,class (:foreground ,grey7 :italic t))))
   `(font-latex-string-face ((,class (:foreground ,oranj4))))
   ...
   `(gnus-header-name ((,class (:foreground ,oranj3))))
   `(gnus-header-subject ((,class (:foreground ,oranj2 :bold t))))
   `(mu4e-view-url-number-face ((,class (:foreground ,oranj3))))
   `(mu4e-cited-1-face ((,class (:foreground ,grey2))))
   `(mu4e-cited-7-face ((,class (:foreground ,grey3))))
   `(mu4e-header-marks-face ((,class (:foreground ,oranj3))))
   `(ffap ((,class (:foreground ,grey5))))
   `(js2-private-function-call ((,class (:foreground ,grey6))))
   `(js2-jsdoc-html-tag-delimiter ((,class (:foreground ,oranj4))))
   `(js2-jsdoc-html-tag-name ((,class (:foreground ,grey6))))
   `(js2-external-variable ((,class (:foreground ,oranj3  ))))
   `(js2-function-param ((,class (:foreground ,grey6))))
   `(js2-jsdoc-value ((,class (:foreground ,oranj4))))
   ...
   `(info-quoted-name ((,class (:foreground ,oranj1))))
   `(info-string ((,class (:foreground ,oranj4))))
   `(icompletep-determined ((,class :foreground ,oranj1)))
   `(undo-tree-visualizer-current-face ((,class :foreground ,oranj1)))
   `(undo-tree-visualizer-default-face ((,class :foreground ,grey2)))
   `(undo-tree-visualizer-unmodified-face ((,class :foreground ,var)))
   `(undo-tree-visualizer-register-face ((,class :foreground ,oranj3)))
   `(slime-repl-inputed-output-face ((,class (:foreground ,oranj3))))
   `(trailing-whitespace ((,class :foreground nil :background ,warning)))
   `(rainbow-delimiters-depth-1-face ((,class :foreground ,grey1)))
   `(rainbow-delimiters-depth-2-face ((,class :foreground ,oranj3)))
   ...
   `(rainbow-delimiters-depth-7-face ((,class :foreground ,oranj3)))
   ...
   `(magit-diffstat-added   ((,class (:foreground ,oranj3))))
   `(magit-diffstat-removed ((,class (:foreground ,var))))
   `(magit-process-ok ((,class (:foreground ,oranj2 :weight bold))))
   ...
   `(lazy-highlight ((,class (:foreground ,grey9 :background ,oranj1))))
   `(term ((,class (:foreground ,grey1 :background ,grey11))))
   `(term-color-black ((,class (:foreground ,grey9 :background ,grey9))))
   `(term-color-blue ((,class (:foreground ,oranj2 :background ,oranj2))))
   `(term-color-red ((,class (:foreground ,grey4 :background ,grey9))))
   `(term-color-green ((,class (:foreground ,oranj3 :background ,grey9))))
   `(term-color-yellow ((,class (:foreground ,var :background ,var))))
   `(term-color-magenta ((,class (:foreground ,oranj1 :background ,oranj1))))
   `(term-color-cyan ((,class (:foreground ,oranj4 :background ,oranj4))))
   ...
   `(helm-separator ((,class (:foreground ,oranj3 :background ,grey11))))
   `(helm-time-zone-current ((,class (:foreground ,oranj1 :background ,grey11))))
   `(helm-time-zone-home ((,class (:foreground ,oranj3 :background ,grey11))))
   `(helm-buffer-not-saved ((,class (:foreground ,oranj3 :background ,grey11))))
   `(helm-buffer-process ((,class (:foreground ,oranj1 :background ,grey11))))
   `(helm-buffer-saved-out ((,class (:foreground ,grey1 :background ,grey11))))
   `(helm-buffer-size ((,class (:foreground ,grey1 :background ,grey11))))
   `(helm-ff-directory ((,class (:foreground ,oranj2 :background ,grey11 :weight bold))))
   ...
   `(helm-grep-running ((,class (:foreground ,oranj2 :background ,grey11))))
   `(helm-moccur-buffer ((,class (:foreground ,oranj2 :background ,grey11))))
   `(helm-source-go-package-godoc-description ((,class (:foreground ,oranj4))))
   `(helm-bookmark-w3m ((,class (:foreground ,oranj3))))
   ...
   `(company-preview-search ((,class (:foreground ,oranj3 :background ,grey11))))
   ...
   `(company-tooltip-common-selection ((,class (:foreground ,oranj4))))
   ...
   `(web-mode-string-face ((,class (:foreground ,oranj4))))
   `(web-mode-type-face ((,class (:inherit ,font-lock-type-face))))
   `(web-mode-html-attr-name-face ((,class (:foreground ,oranj2))))
   `(web-mode-html-attr-value-face ((,class (:foreground ,grey4))))
   `(web-mode-warning-face ((,class (:inherit ,font-lock-warning-face))))
   `(web-mode-html-tag-face ((,class (:foreground ,oranj1))))
   ...
   `(wg-mode-line-face ((,class (:foreground ,oranj1))))
   `(wg-divider-face ((,class (:foreground ,oranj1))))
   `(ahs-plugin-defalt-face ((,class (:background ,oranj5))))
