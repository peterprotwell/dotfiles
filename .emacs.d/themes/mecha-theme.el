...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(term-color-red ((,class (:foreground ,oranj3 :background ,oranj3))))
   `(term-color-green ((,class (:foreground ,oranj4 :background ,oranj4))))
   `(term-color-yellow ((,class (:foreground ,oranj1 :background ,oranj1))))
   `(term-color-magenta ((,class (:foreground ,oranj2 :background ,oranj2))))
